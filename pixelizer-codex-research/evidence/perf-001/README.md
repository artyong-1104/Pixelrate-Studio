...
[2026-09-06 새 측정·크레딧 차단·재개 지점](current-20260906/README.md). 기존 최종 gate는 미완료 상태다.

# 2026-09-06 재검증

현재 소스의 기존 gate는 stale HTML 해시로 FAIL. 새 IAB Worker 취소와 재실행 측정을 별도 기록했으며 Chrome 접근 차단 및 나머지 증거 갱신이 남았다. [현재 전체 검증 및 제약](../completion-20260906/README.md). 아래 과거 기록은 해당 날짜의 스냅샷이다.
