...
```text
Content-Security-Policy: default-src 'none'; script-src 'self' 'sha256-G/bhVsE3S2y4CkbPDY6LtdHKsBbk2xxx3t1BTJkggNo='; style-src 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self'; connect-src 'none'; object-src 'none'; base-uri 'none'; form-action 'none'; frame-ancestors 'none'; manifest-src 'none'; media-src 'none'; worker-src 'none'
