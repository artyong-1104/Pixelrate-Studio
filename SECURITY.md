...
```text
Content-Security-Policy: default-src 'none'; script-src 'self' 'sha256-K1zoyUoXkcoUC6fiQBXMO6hhr832xcXlf8TP30HIvVE='; style-src 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self'; connect-src 'none'; object-src 'none'; base-uri 'none'; form-action 'none'; frame-ancestors 'none'; manifest-src 'none'; media-src 'none'; worker-src 'none'
